...
<script type="text/javascript" charset="utf-8">	
	$(document).ready(function() {
		var oTable = get_list_init(210,0,0);	
		$("#edit_btn").click(function(){				
            ...
            if(anSelected.length == 0) {
                var pop=new Pop("操作失败","没有选中修改行，请单击选择要修改的行！");
                        ...
                        location.href = "user_mant.php?action=edit&id="+selectedId;
                    }
		});
...
<fieldset> 
  <legend>系统用户信息
	...
	?>
	&nbsp;&nbsp;
	<a href="user_mant.php?action=save"><img src="images/add-.gif" title="添加信息" border="0"/></a>
	<?php
		}
		if(canAdm()) {
	?>
...
<table cellpadding="0" cellspacing="0" border="0"  id="example" width="100%">
	...
	<tfoot>
		<tr class="highlighted">
			<th><input type="text" name="按所属分校搜索" value="按所属分校搜索" class="search_init" /></th>
			<th>
