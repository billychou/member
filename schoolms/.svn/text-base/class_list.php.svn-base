			...
			$(document).ready(function() {
				...
				$("#edit_btn").click(function(){				
					...
					if(anSelected.length == 0) {
						...
						location.href = "class_mant.php?action=edit&id="+selectedId;
					}
				});
...
<div class="zt">
 <fieldset> 
  <legend>班级信息
	...
	?>
	&nbsp;&nbsp;
	<a href="class_mant.php?action=save"><img src="images/add-.gif" title="添加信息" border="0"/></a>
	<?php
		}
...
<table cellpadding="0" cellspacing="0" border="0"  id="example" width="100%">
	...
	<tbody>		
			...
			?>
				<tr id="<?php echo $class['id']?>">
					<td><?php echo $class['updatetime'] ?></td>
					<td><?php echo $class['majorname'] ?></td>
					<td><?php echo $class['classname'] ?></td>
					<td><?php echo $class['createat'] ?></td>
					<td><?php echo $class['closeat'] ?></td>
