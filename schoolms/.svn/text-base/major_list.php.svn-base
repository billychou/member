			...
			$(document).ready(function() {
				...
				$("#edit_btn").click(function(){				
					...
					if(anSelected.length == 0) {
						...
						location.href = "major_mant.php?action=edit&id="+selectedId;
					}
				});
...
<div class="zt">
 <fieldset> 
  <legend>专业信息
	...
	?>
	&nbsp;&nbsp;
	<a href="major_mant.php?action=save"><img src="images/add-.gif" title="添加信息" border="0"/></a>
	<?php
		}
		if(canAdm()&& isHeadQuarter()) {
	?>
...
<table cellpadding="0" cellspacing="0" border="0"  id="example" width="100%">
	...
	<tbody>		
			...
			?>
				<tr id="<?php echo $major['id']?>">
					<td>
						<?php echo $major['name'] ?>
					</td>
					<td>
						<?php echo $major['updatetime'] ?>
					</td>
