...
?>
	...
	<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
				...
				var oTable = get_list_init(230,1,1);
				...
				$("#edit_btn").click(function(){				
					...
					if(anSelected.length == 0) {
						...
						location.href = "branch_mant.php?action=edit&id="+selectedId;
					}
				});
...
<div class="zt">
 <fieldset> 
  <legend>分校信息
	...
	?>
	&nbsp;&nbsp;
	<a href="branch_mant.php?action=save"><img src="images/add-.gif" title="添加信息" border="0"/></a>
	<?php
		}
		if(canAdm()&& isHeadQuarter()) {
	?>
...
<table cellpadding="0" cellspacing="0" border="0"  id="example" width="100%">
	...
	<tfoot>
		<tr class="highlighted">
			...
			<th><input type="text" name="按负责人搜索" value="按负责人搜索" class="search_init" /></th>
	...
	<tbody>		
			...
			?>
				<tr id="<?php echo $branch['id']?>">
					...
					<td>
						<?php echo $branch['updatetime'] ?>
					</td>
					<td><?php echo $branch['owner'] ?></td>
					<td>
						<?php echo $branch['note'] ?>
					</td>
				</tr>
			<?php	
                                }
