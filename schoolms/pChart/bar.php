<?php
 ...
 $MyData->setAxisName(0,"金额");
 $MyData->addPoints(array("进货","Feb","Mar","Apr","May","Jun"),"Labels");
 ...
 $myPicture->setFontProperties(array("FontName"=>"fonts/SIMHEI.TTF","FontSize"=>6));
 $myPicture->drawText(10,13,"drawBarChart() - draw a bar chart",array("R"=>255,"G"=>255,"B"=>255));

 /* Write the chart title */ 
 $myPicture->setFontProperties(array("FontName"=>"fonts/SIMHEI.TTF","FontSize"=>11));
